void poissonf3_4_1() {
    ...
    // Читаємо 3 колонки
    tree->ReadFile("final_data3_4.csv", "timestamp/C:cpm/I:minute/I", ',');

    TCanvas *c1 = new TCanvas("c1", "Poisson Distribution (3000)", 800, 600);
    ...
    leg->AddEntry(hist, "Experimental data (3000 min)", "f");
    leg->AddEntry(gfit, "Gaussian fit", "l");    
    leg->SetTextSize(0.035);
    leg->Draw();
    c1->SaveAs("poisson_result3_4_1.png");
}
